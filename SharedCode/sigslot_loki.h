/*
 ...
 1. #define switches
    ...
    SIGSLOT_LOKI_PURE_ISO:
    Define this to force ISO C++ compliance. This also disables
    all of the thread safety support on platforms where it is 
    available.
 
    SIGSLOT_LOKI_USE_POSIX_THREADS:
    Force use of Posix threads when using a C++ compiler other than
    gcc on a platform that supports Posix threads. (When using gcc,
    this is the default - use SIGSLOT_LOKI_PURE_ISO to disable this if 
    necessary)
 
    SIGSLOT_LOKI_DEFAULT_MT_POLICY:
 ...
 2. PLATFORM NOTES
    ...
    (as under Windows) with the SIGSLOT_LOKI_PURE_ISO switch. If you're using
    something other than gcc but still want to use Posix threads, you
    need to #define SIGSLOT_LOKI_USE_POSIX_THREADS.
 
    ISO C++:
    If none of the supported platforms are detected, or if
    SIGSLOT_LOKI_PURE_ISO is defined, all multithreading support is turned off,
...
#ifndef SIGSLOT_LOKI_H
#define SIGSLOT_LOKI_H

#include <set>
#include <list>

// change according to your needs:
#define SIGSLOT_LOKI_PURE_ISO

#if defined(SIGSLOT_LOKI_PURE_ISO) || (!defined(WIN32) && !defined(__GNUG__) && !defined(SIGSLOT_LOKI_USE_POSIX_THREADS))
  #define SIGSLOT_LOKI_SINGLE_THREADED
#elif defined(WIN32)
  #define SIGSLOT_LOKI_HAS_WIN32_THREADS
  #include <windows.h>
#elif defined(__GNUG__) || defined(SIGSLOT_LOKI_USE_POSIX_THREADS)
  #define SIGSLOT_LOKI_HAS_POSIX_THREADS
  #include <pthread.h>
#else
  #define SIGSLOT_LOKI_SINGLE_THREADED
#endif

#ifndef SIGSLOT_LOKI_DEFAULT_MT_POLICY
  #ifdef SIGSLOT_LOKI_SINGLE_THREADED
    #define SIGSLOT_LOKI_DEFAULT_MT_POLICY single_threaded
  #else
    #define SIGSLOT_LOKI_DEFAULT_MT_POLICY multi_threaded_local
  #endif
#endif
...
namespace sigslot_loki {
...
#ifdef SIGSLOT_LOKI_HAS_WIN32_THREADS
...
#endif // SIGSLOT_LOKI_HAS_WIN32_THREADS
    
#ifdef SIGSLOT_LOKI_HAS_POSIX_THREADS
    // The multi threading policies only get compiled in if they are enabled.
    class multi_threaded_global
    {
    public:
...
#endif // SIGSLOT_LOKI_HAS_POSIX_THREADS
    ...
    template<class mt_policy = SIGSLOT_LOKI_DEFAULT_MT_POLICY>
    ...
    template<class arg1_type, class mt_policy = SIGSLOT_LOKI_DEFAULT_MT_POLICY>
    ...
    template<class arg1_type, class arg2_type, class mt_policy = SIGSLOT_LOKI_DEFAULT_MT_POLICY>
    ...
    template<class arg1_type, class arg2_type, class arg3_type, class mt_policy = SIGSLOT_LOKI_DEFAULT_MT_POLICY>
    ...
    template<class arg1_type, class arg2_type, class arg3_type, class arg4_type, class mt_policy = SIGSLOT_LOKI_DEFAULT_MT_POLICY>
    ...
    template<class arg1_type, class arg2_type, class arg3_type, class arg4_type,
    class arg5_type, class mt_policy = SIGSLOT_LOKI_DEFAULT_MT_POLICY>
    ...
    template<class arg1_type, class arg2_type, class arg3_type, class arg4_type,
    class arg5_type, class arg6_type, class mt_policy = SIGSLOT_LOKI_DEFAULT_MT_POLICY>
    ...
    template<class arg1_type, class arg2_type, class arg3_type, class arg4_type,
    class arg5_type, class arg6_type, class arg7_type, class mt_policy = SIGSLOT_LOKI_DEFAULT_MT_POLICY>
    ...
    template<class arg1_type, class arg2_type, class arg3_type, class arg4_type,
    class arg5_type, class arg6_type, class arg7_type, class arg8_type, class mt_policy = SIGSLOT_LOKI_DEFAULT_MT_POLICY>
