/*
 ...
 1. #define switches
    ...
    SIGSLOTLIANGSHI_PURE_ISO:
    Define this to force ISO C++ compliance. This also disables
    all of the thread safety support on platforms where it is 
    available.
 
    SIGSLOTLIANGSHI_USE_POSIX_THREADS:
    Force use of Posix threads when using a C++ compiler other than
    gcc on a platform that supports Posix threads. (When using gcc,
    this is the default - use SIGSLOTLIANGSHI_PURE_ISO to disable this if 
    necessary)
 
    SIGSLOTLIANGSHI_DEFAULT_MT_POLICY:
 ...
 2. PLATFORM NOTES
    ...
    (as under Windows) with the SIGSLOTLIANGSHI_PURE_ISO switch. If you're using
    something other than gcc but still want to use Posix threads, you
    need to #define SIGSLOTLIANGSHI_USE_POSIX_THREADS.
 
    ISO C++:
    If none of the supported platforms are detected, or if
    SIGSLOTLIANGSHI_PURE_ISO is defined, all multithreading support is turned off,
...
#ifndef SIGSLOTLIANGSHI_H
#define SIGSLOTLIANGSHI_H

#include <set>
#include <list>

// change according to your needs:
#define SIGSLOTLIANGSHI_PURE_ISO

#if defined(SIGSLOTLIANGSHI_PURE_ISO) || (!defined(WIN32) && !defined(__GNUG__) && !defined(SIGSLOTLIANGSHI_USE_POSIX_THREADS))
  #define SIGSLOTLIANGSHI_SINGLE_THREADED
#elif defined(WIN32)
  #define SIGSLOTLIANGSHI_HAS_WIN32_THREADS
  #include <windows.h>
#elif defined(__GNUG__) || defined(SIGSLOTLIANGSHI_USE_POSIX_THREADS)
  #define SIGSLOTLIANGSHI_HAS_POSIX_THREADS
  #include <pthread.h>
#else
  #define SIGSLOTLIANGSHI_SINGLE_THREADED
#endif

#ifndef SIGSLOTLIANGSHI_DEFAULT_MT_POLICY
  #ifdef SIGSLOTLIANGSHI_SINGLE_THREADED
    #define SIGSLOTLIANGSHI_DEFAULT_MT_POLICY single_threaded
  #else
    #define SIGSLOTLIANGSHI_DEFAULT_MT_POLICY multi_threaded_local
  #endif
#endif
...
namespace sigslot_liangshi {
...
#ifdef SIGSLOTLIANGSHI_HAS_WIN32_THREADS
...
#endif // SIGSLOTLIANGSHI_HAS_WIN32_THREADS
    
#ifdef SIGSLOTLIANGSHI_HAS_POSIX_THREADS
    // The multi threading policies only get compiled in if they are enabled.
    class multi_threaded_global
    {
    public:
...
#endif // SIGSLOTLIANGSHI_HAS_POSIX_THREADS
    ...
    public:
        ...
        virtual has_slots<mt_policy>* getdest() const = 0;
        virtual void emit1(arg1_type) = 0;
    ...
    public:
        ...
        virtual has_slots<mt_policy>* getdest() const = 0;
        virtual void emit1(arg1_type, arg2_type) = 0;
    ...
    public:
        ...
        virtual has_slots<mt_policy>* getdest() const = 0;
        virtual void emit1(arg1_type, arg2_type, arg3_type) = 0;
    ...
    public:
        ...
        virtual has_slots<mt_policy>* getdest() const = 0;
        virtual void emit1(arg1_type, arg2_type, arg3_type, arg4_type) = 0;
    ...
    public:
        ...
        virtual has_slots<mt_policy>* getdest() const = 0;
        virtual void emit1(arg1_type, arg2_type, arg3_type, arg4_type, 
                          arg5_type) = 0;
    ...
    public:
        ...
        virtual has_slots<mt_policy>* getdest() const = 0;
        virtual void emit1(arg1_type, arg2_type, arg3_type, arg4_type, arg5_type,
                          arg6_type) = 0;
    ...
    template<class mt_policy = SIGSLOTLIANGSHI_DEFAULT_MT_POLICY>
    ...
    public:
        ...
        virtual void emit1(arg1_type a1)
        {
    ...
    public:
        ...
        virtual void emit1(arg1_type a1, arg2_type a2)
        {
    ...
    public:
        ...
        virtual void emit1(arg1_type a1, arg2_type a2, arg3_type a3)
        {
    ...
    public:
        ...
        virtual void emit1(arg1_type a1, arg2_type a2, arg3_type a3, arg4_type a4,
                          arg5_type a5)
        {
    ...
    template<class arg1_type, class mt_policy = SIGSLOTLIANGSHI_DEFAULT_MT_POLICY>
    ...
    template<class arg1_type, class arg2_type, class mt_policy = SIGSLOTLIANGSHI_DEFAULT_MT_POLICY>
    ...
    public:
        ...
        void emit1(arg1_type a1, arg2_type a2)
        {
            lock_block<mt_policy> lock(this);
            typename connections_list::const_iterator itNext, it = m_connected_slots.begin();
            typename connections_list::const_iterator itEnd = m_connected_slots.end();
    ...
    template<class arg1_type, class arg2_type, class arg3_type, class mt_policy = SIGSLOTLIANGSHI_DEFAULT_MT_POLICY>
    ...
    public:
        ...
        void emit1(arg1_type a1, arg2_type a2, arg3_type a3)
        {
            lock_block<mt_policy> lock(this);
            typename connections_list::const_iterator itNext, it = m_connected_slots.begin();
            typename connections_list::const_iterator itEnd = m_connected_slots.end();
    ...
    template<class arg1_type, class arg2_type, class arg3_type, class arg4_type, class mt_policy = SIGSLOTLIANGSHI_DEFAULT_MT_POLICY>
    ...
    public:
        ...
        void emit1(arg1_type a1, arg2_type a2, arg3_type a3, arg4_type a4)
        {
            lock_block<mt_policy> lock(this);
            typename connections_list::const_iterator itNext, it = m_connected_slots.begin();
            typename connections_list::const_iterator itEnd = m_connected_slots.end();
    ...
    template<class arg1_type, class arg2_type, class arg3_type, class arg4_type,
    class arg5_type, class mt_policy = SIGSLOTLIANGSHI_DEFAULT_MT_POLICY>
    ...
    template<class arg1_type, class arg2_type, class arg3_type, class arg4_type,
    class arg5_type, class arg6_type, class mt_policy = SIGSLOTLIANGSHI_DEFAULT_MT_POLICY>
    ...
    template<class arg1_type, class arg2_type, class arg3_type, class arg4_type,
    class arg5_type, class arg6_type, class arg7_type, class mt_policy = SIGSLOTLIANGSHI_DEFAULT_MT_POLICY>
    ...
    template<class arg1_type, class arg2_type, class arg3_type, class arg4_type,
    class arg5_type, class arg6_type, class arg7_type, class arg8_type, class mt_policy = SIGSLOTLIANGSHI_DEFAULT_MT_POLICY>
    ...
    public:
                  ...
                  arg5_type a5, arg6_type a6, arg7_type a7, arg8_type a8)
        {
            ...
            while (it != itEnd) {
                itNext = it;
                ++itNext;
                (*it)->emit1(a1, a2, a3, a4, a5, a6, a7, a8);
                it = itNext;
            }
        }
