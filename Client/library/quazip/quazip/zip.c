...
//GuoYong 2013Äê6ÔÂ20ºÅ 10:30
//4b50 KP
//5947 YG

#define SIZEDATA_INDATABLOCK (4096-(4*4))

#define LOCALHEADERMAGIC    (0x04035947)
#define DESCRIPTORHEADERMAGIC    (0x08075947)
#define CENTRALHEADERMAGIC  (0x02015947)
#define ENDHEADERMAGIC      (0x06055947)
